     ...
     <section className="relative min-h-[60vh] md:min-h-[80vh] lg:min-h-[90vh] flex items-center overflow-hidden mb-12 md:mb-0">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 mt-20 rounded-full bg-primary/20 text-primary text-sm font-medium md:mt-0 mb-6 backdrop-blur-sm border border-primary/30">
