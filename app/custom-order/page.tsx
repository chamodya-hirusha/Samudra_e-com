        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <motion.form
              ...
              className="bg-card rounded-2xl p-4 sm:p-6 md:p-8 shadow-card"
            >
                    ...
                    {imagePreviews.map((preview, index) => (
                      <div key={index} className="relative group">
                        ...
                        <button
                          ...
                          className="absolute top-1 right-1 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-destructive text-destructive-foreground flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                        >
